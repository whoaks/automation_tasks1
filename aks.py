...
while True:
    ...
    if cmd=='1':
        ...
        if cmd2=='1':
            ...
            s3_name=input()
            os.system('aws s3api create-bucket --bucket {} --region ap-south-1 --create-bucket-configuration 
            LocationConstraint=ap-south-1'.format(s3_name))
